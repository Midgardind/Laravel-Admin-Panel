...
<div class="card">
    <div class="card-header">
      <div class="row">
          ...
          <div class="col-md-2">
            <a href="/admin/blog" class="btn btn-primary btn-sm float-right m-0 py-1">Blog Home</a>
          </div>
      </div>
    </div>
            ...
            <div class="py-2 my-0">
              <label class=""><strong>Category: </strong> {{$post->category->name}}</label>
        		...
        		<div class="my-0">
       			...
       			<div class="row">
       				<div class="col-sm-6">
       					{!! Html::linkRoute('admin-blog.blog.edit', 'Edit', array($post->id), array('class' => 'btn btn-primary btn-block')) !!}
       				</div>
       				<div class="col-sm-6">
